                                ...
                                <div class="col-md-6 row">
                                    <div class="col-lg-6">
                                        <div class="form-check">
                                            <input id="payment_method" type="radio" class="form-check-input{{ $errors->has('payment_method') ? ' is-invalid' : '' }}" name="payment_method" value="Credit Card" required>
                                            <label class="form-check-label">Credit Card</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-check">
                                            <input id="payment_method" type="radio" class="form-check-input{{ $errors->has('payment_method') ? ' is-invalid' : '' }}" name="payment_method" value="Cash" required>
